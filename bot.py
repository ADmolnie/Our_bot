...
/year - чабарнутая штука, которая выдаёт тебе фильм по дате выпуска (нужно писать так: пишем мначала знак >, < или = затем в '' пишем: год (> '2009'))
                     
/rating - сортирует по рейтингу, пишем почти также, как и /year (знак >, < или =, затем в '' пишем: цифра.цифра (> '8.9'))
